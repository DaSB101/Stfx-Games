...
gdjs.evtsExt__YSort__YSort.YSort = class YSort extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.ZOffset = behaviorData.ZOffset !== undefined ? behaviorData.ZOffset : Number("0") || 0;
  }

  // Hot-reload:
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    
    if (oldBehaviorData.ZOffset !== newBehaviorData.ZOffset)
      this._behaviorData.ZOffset = newBehaviorData.ZOffset;
  ...
  _getZOffset() {
    return this._behaviorData.ZOffset !== undefined ? this._behaviorData.ZOffset : Number("0") || 0;
  }
  _setZOffset(newValue) {
    this._behaviorData.ZOffset = newValue;
  }
}
...
{for(var i = 0, len = gdjs.evtsExt__YSort__YSort.YSort.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__YSort__YSort.YSort.prototype.doStepPostEventsContext.GDObjectObjects1[i].setZOrder((gdjs.evtsExt__YSort__YSort.YSort.prototype.doStepPostEventsContext.GDObjectObjects1[i].getY()) + (gdjs.evtsExt__YSort__YSort.YSort.prototype.doStepPostEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getZOffset()));
}
}}
